...
/usr/local/bin/pandoc --toc --latex-engine=xelatex --template ~/Dropbox/Active/Repos/Pandoc\ Templates/default_endFloat.latex --self-contained --standalone goalsAndObjectives.md -o goalsAndObjectives.pdf
