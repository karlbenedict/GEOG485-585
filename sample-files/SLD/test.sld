    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name></se:Name>
          <se:Description>
            <se:Title> TYPE is 'Interstate'</se:Title>
          </se:Description>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#e70003</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name></se:Name>
          <se:Description>
            <se:Title> TYPE is 'US Highway'</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>TYPE</ogc:PropertyName>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#231de7</se:SvgParameter>
